...
{
    // Init filters.
    let filters = JSON.parse(sessionStorage.getItem('django.api_admin.filtersState'));
    ...
    details.forEach(detail => {
        detail.addEventListener('toggle', event => {
            ...
            sessionStorage.setItem('django.api_admin.filtersState', JSON.stringify(filters));
        });
    });
}
