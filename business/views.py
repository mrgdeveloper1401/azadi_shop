...
from .models import Top_Students, Top_Teachers, Tajrobi_Top_Levels, Riazi_Top_Levels, Enasani_Top_Levels, Prizes, \
    Obligations
from .serializers import TopTeachersSerializer, TopStudentsSerializer, TajrobiTopLevelsSerializer, \
    RiaziTopLevelsSerializer, EnasaniTopLevelsSerializer, PrizesSerializer, ObligationsSerializer, CoursesSerializers
